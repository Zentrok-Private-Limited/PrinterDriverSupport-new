...
const navItems: { id: BrandId; label: string }[] = [
  { id: 'home', label: 'Home' },
  { id: 'hp', label: 'HP' },
  ...
  return (
    <div className="bw-shell bw-body-pad">
      ...
      <main>
        ...
        <section className="bw-help-strip">
          ...
          <div className="bw-help-actions">
            ...
            <button type="button" className="bw-chat-btn" onClick={() => setModalStep('connection')}>
        ...
        <section className="bw-setup-guide" aria-labelledby="bw-setup-guide-title">
          <div className="bw-guide-media">
            <img
              ...
              src="https://images.pexels.com/photos/7923946/pexels-photo-7923946.jpeg?auto=compress&cs=tinysrgb&w=900"
        ...
        <section className="bw-offline-guide" aria-labelledby="bw-offline-guide-title">
          ...
          <div className="bw-guide-media">
            <img
              className="bw-guide-image"
              src="https://images.pexels.com/photos/7923942/pexels-photo-7923942.jpeg?auto=compress&cs=tinysrgb&w=900"
        ...
        <div className="bw-disclaimer-section">
          <section className="bw-disclaimer" aria-label="Disclaimer">
            ...
            <p className="bw-disclaimer-copy">This website provides independent printer setup and troubleshooting information for general guidance. Product names, logos, and brands are used for identification purposes only and remain the property of their respective owners. We are not affiliated with or endorsed by any printer manufacturer.</p>
          </section>
        </div>
        ...
        <footer className="bw-footer" aria-label="Printer support footer" id="contact-section">
          <div className="bw-footer-info">
            <section>
              ...
              <p className="bw-footer-copy">Our team helps identify common printer issues, whether they involve hardware, software, connectivity, or setup. We focus on clear guidance and dependable assistance for users who want help keeping their printers running smoothly.</p>
            </section>
            <section>
              <h2 className="bw-footer-title">Printer Issue Diagnosis</h2>
              <p className="bw-footer-copy">Modern printers have many built-in features, and even small glitches can disrupt everyday tasks. Our team follows practical troubleshooting steps to review driver, print queue, scanner, wireless, and paper-feed issues so common printer problems can be addressed efficiently.</p>
            </section>
          </div>
      ...
      <div className="bw-support-footer">
        <button type="button" className="bw-support-footer__item" onClick={() => setModalStep('connection')}>
