    ...
    <div className="min-h-screen bg-white antialiased text-[#333333] font-subheading font-normal text-[15px]">
      ...
      <section className="w-full bg-white border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
          ...
          <a href="/hp/laptop-setup" className="py-5 px-4 flex flex-col items-center justify-center group hover:bg-gray-50 transition-colors">
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <a href="/hp/laptop-setup" className="bg-[#3A76D2] text-white px-6 py-2.5 text-[15px] font-medium rounded-sm hover:bg-[#2C5EB0] transition-colors font-heading shadow-sm">
                Computer Setup
              </a>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            ...
            <div className="flex flex-col items-center px-4">
              ...
              <a href="/hp/laptop-setup" className="bg-[#3A76D2] text-white px-5 py-2 text-[14px] font-medium rounded-sm hover:bg-[#2C5EB0] transition-colors mb-4 font-heading">
                Fix Performance
              </a>
      ...
      <section className="w-full bg-[#F3F7FA] border-t border-gray-200 py-16 px-6">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <a href="/hp/laptop-setup" className="border border-[#3A76D2] text-[#3A76D2] px-5 py-2.5 text-[14px] font-medium rounded-sm hover:bg-blue-50 transition-colors font-heading">
